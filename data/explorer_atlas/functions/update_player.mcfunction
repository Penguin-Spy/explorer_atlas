...
execute unless score @s explorer_atlas.hud_delay matches 1.. if data storage explorer_atlas:temp string run title @s actionbar ["",{"nbt":"string[0]","storage":"explorer_atlas:temp","interpret":true},{"nbt":"string[1]","storage":"explorer_atlas:temp","interpret":true},{"nbt":"string[2]","storage":"explorer_atlas:temp","interpret":true},{"nbt":"string[3]","storage":"explorer_atlas:temp","interpret":true},{"nbt":"string[4]","storage":"explorer_atlas:temp","interpret":true},{"nbt":"string[5]","storage":"explorer_atlas:temp","interpret":true}]
