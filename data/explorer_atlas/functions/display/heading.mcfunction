...
execute if predicate explorer_atlas:display_random run data modify storage explorer_atlas:temp string append value '[{"score":{"name":"$random.heading","objective":"explorer_atlas.temp"}},"°"]'
